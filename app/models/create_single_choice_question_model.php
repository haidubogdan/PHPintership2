...
class SingleChoiceQuestionModel implements QuestionCreatorModel 
{
    public $question_name;
    public $question_text;
    static $question_type_input = "single_choice";
    static $question_type = "Single Choice Question";
    private $view_path = "single_choice_question_form_view";
